...
router.get(
  "/presensi/:id",
  checkAuthMiddleware.checkAuth("peserta_magang"),
  userController.showPresensi
);
router.patch(
  "/presensi/:id/up",
  uploadProtectionMiddleware.protectUpload,
  async (req, res) => {
...
router.patch(
  "/peserta/:id/edit-password",
  checkAuthMiddleware.checkAuth("peserta_magang"),
  userController.editPassword
);
router.get(
  "/peserta/:id/sisa-waktu",
  checkAuthMiddleware.checkAuth("peserta_magang"),
  userController.hitungSisaWaktuMagang
);
